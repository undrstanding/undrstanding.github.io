...
(function () {
    ...
    // Failsafe: if page takes too long to load, hide anyway
...
document.addEventListener('DOMContentLoaded', () => {
    // Exclude index page and flashcards page
    if (document.getElementById('site-search') || document.getElementById('stack-container')) return;
