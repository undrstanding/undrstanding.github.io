...
class QuizManager {
    ...
    render() {
        ...
        header.innerHTML = `
            ...
            <p class="text-sm text-gray-600">Answer all 10 questions correctly to unlock your certificate. Score: <span id="quiz-score" class="font-bold">0</span>/${this.questions.length}</p>
        `;
    ...
    renderIntro() {
        ...
        desc.textContent = "Ready to prove your skills? Take the certification quiz. Score 10/10 to unlock your personalized certificate of completion.";
...
document.addEventListener('DOMContentLoaded', () => {
    // Exclude index page (it has its own Hero Search)
